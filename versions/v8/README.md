# Spectrum Algo — Dictionary v8 Snapshot

**Date captured:** 2026-04-16  
**Dict version:** 8  
**SPEC_TOKEN_COUNT:** 234,830  
**Languages covered:** Python, HTML, JS, CSS, Text, TypeScript, SQL, Rust  

## Contents

This directory is a read-only snapshot of the core encoding logic as it existed at dictionary version 8.  It is provided for reference, auditing, and comparison across versions.
