# Spectrum Algo — Dictionary v10 Snapshot

**Date captured:** 2026-04-30  
**Dict version:** 10  
**SPEC_TOKEN_COUNT:** 234,957  
**Languages covered:** Python, HTML, JS, CSS, Text, TypeScript, SQL, Rust, PHP, XML/Wiki  

## Contents

This directory is a read-only snapshot of the core encoding logic as it existed at dictionary version 10.  It is provided for reference, auditing, and comparison across versions.
