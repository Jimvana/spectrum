...
# Extension helpers
# ---------------------------------------------------------------------------
COMPRESSIBLE = {".py", ".js", ".html", ".htm", ".css", ".mjs", ".cjs", ".txt", ".md"}
SPEC_EXT     = ".spec"
PNG_EXT      = ".png"
...
class FileRow:
    ...
    def _detect_lang(self):
        m = {".py": "Python", ".js": "JavaScript", ".html": "HTML",
             ...
             ".cjs": "JavaScript", ".txt": "Plain Text", ".md": "Markdown",
             ".spec": "Spectrum .spec", ".png": "Spectrum PNG"}
...
class SpectrumGUI(tk.Tk):
    ...
    def _add_files(self):
        paths = filedialog.askopenfilenames(
            title="Add Files",
            filetypes=[
                ("All supported", "*.py *.js *.html *.htm *.css *.mjs *.cjs *.txt *.md *.spec *.png"),
    ...
    def _start_compress(self):
        ...
        if not sources:
            messagebox.showwarning("No compressible files",
                                   "Add Python, JS, HTML, CSS, or plain text (.txt) source files first.")
            return
    ...
    def _show_about(self):
        ...
        for line in [
            ...
            "Languages: Python · JavaScript · HTML · CSS · Plain Text",
            "Dictionary version 7  ·  234,728 tokens",
        ]:
